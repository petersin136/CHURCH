      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="space-y-3 md:space-y-6 lg:space-y-8">
            ...
            <p className="text-base md:text-2xl lg:text-3xl xl:text-4xl text-white font-medium" style={{ lineHeight: '1.5' }}>
              온라인 교회는 열어둘 수 있습니다.
            </p>
            ...
            <div className="pt-4 md:pt-8 lg:pt-12">
              <p className="text-lg md:text-4xl lg:text-5xl xl:text-6xl text-white font-bold leading-tight border-t border-gray-700 pt-4 md:pt-8 lg:pt-12 inline-block">
                그것이 홈페이지입니다.
                </p>
              </div>
          </div>
