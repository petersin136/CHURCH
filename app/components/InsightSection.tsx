      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-2 md:space-y-4 lg:space-y-5">
            <p className="text-sm md:text-lg lg:text-xl xl:text-2xl font-serif text-gray-800 leading-relaxed">
            ...
            <p className="text-sm md:text-lg lg:text-xl xl:text-2xl font-serif text-gray-800 leading-relaxed font-bold">
              홈페이지를 만듭니다.
            </p>
          </div>
        </div>
